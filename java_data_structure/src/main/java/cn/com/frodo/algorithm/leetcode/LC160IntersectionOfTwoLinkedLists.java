 ...
 */
@AlgorithmPoint(
        tag = {AlgorithmPoint.Tag.leetcode, AlgorithmPoint.Tag.offer, AlgorithmPoint.Tag.frequently},
        difficulty = AlgorithmPoint.Difficulty.easy,
        category = AlgorithmPoint.Category.array,
        algorithm = @Algorithm(value = Algorithm.AlgorithmEnum.twoPointers))
public class LC160IntersectionOfTwoLinkedLists implements IAlgorithm {
